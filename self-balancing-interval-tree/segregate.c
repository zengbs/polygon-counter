...
void LomutoPartition( EventListX_wrapper *wrapper, int leftEnd, int rightEnd )
{
    ...
    for (int i = leftEnd; i <= rightEnd; i++){
        ...
        if ( ( wrapper[i].KeyX & 1 ) == 1 ){
            ...
            //XorSwap( &(wrapper[i].EventListX), &(wrapper[j].EventListX) );
        }
    }
}
...
//   wrapper[2].EventListX = 1;  wrapper[2].KeyX = 2;
//   wrapper[3].EventListX = 1;  wrapper[3].KeyX = 3;
//   wrapper[4].EventListX = 2;  wrapper[4].KeyX = 4;
//   wrapper[5].EventListX = 2;  wrapper[5].KeyX = 5;
//
